            ...
            <form class="from_cart_register" action="" method="post" style="width: 500px;margin:0 auto;padding: 30px 0">
                ...
                <div class="form-group">
                    ...
                    <p>
                        ...
                        <button class="btn btn-purple" style="background:#ff8822"><a href="auth/google">Đăng nhập bằng Google </a></button>
                        <button class="btn btn-purple"style="background:#ffeb3be6"><a href="{{ route('get.register') }}">Đăng ký</a></button>

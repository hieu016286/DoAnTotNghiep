	...
	<div class="col-md-10">
		<div class="row">
			...
			<div class="col-md-2">
				<div class="form-group {{ $errors->first('ie_number') ? 'has-error' : '' }}">
					<label for="name">Số lượng nhập <span class="text-danger">(*)</span></label>
					<input type="number" min="0" class="form-control" id="qty2" required value="{{ old('ie_number',$invoiceEntered->ie_number ?? 1) }}" name="ie_number2" placeholder="10 ...">
				</div>
			</div>
			<div class="col-sm-2">
				<div class="form-group {{ $errors->first('ie_number') ? 'has-error' : '' }}">
					<label for="name">Giá nhập <span class="text-danger">(*)</span></label>
					<input type="number" min="0" required class="form-control js-money-input2" value="{{ old('ie_money',$invoiceEntered->ie_money ?? 0) }}" name="ie_money2" placeholder="10000 ...">
				</div>
			</div>
			<div class="col-md-2">
				<div class="form-group" id="time">
